    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        {Array.isArray(taxBrackets) && taxBrackets.length > 0 ? (
          ...
          <div className="text-center py-4">
            <p className="text-gray-500">
              No tax bracket information available for {selectedYear}.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="px-6 py-4 bg-gray-50">
        <p className="text-xs text-gray-500">
          Note: These tax rates apply to South African residents. Non-residents may be subject to
          different rates. Tax rebates and thresholds are not reflected in this table.
        </p>
      </div>
    </div>
  );
